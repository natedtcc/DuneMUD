...
int do_buy (string str)
{
  ...
  if (present("pusherman")){
    ...
    if (str == "sapho"){
      ...
      tell_object(
      TP, "Pusher Man says: Here's your sapho, kid. I'm sure I'll see ya"
    ...
    if (str == "pipe") {
      ...
      tell_object(
      TP, "Pusher Man says: Ok, here's a pipe. Want me to smoke it for you"
...
int do_list (string str) {
  write(
    "Yo, I got you. Just type 'buy sapho' for some red tar, "
    +"or 'buy pipe'.");
  }
