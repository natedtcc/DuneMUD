...
void reset(int arg){
  ...
  "To the west is some living quarters and to your east is the food gardens."+
  "\n\n");

  add_exit("north","/d/Atreid/kiza/ubase/hall1.c");
  add_exit("west","/d/Atreid/kiza/ubase/res2.c");
  add_exit("east","/d/Atreid/kiza/ubase/foodhall.c");
  add_exit("south","/d/Atreid/kiza/ubase/hall3.c");
