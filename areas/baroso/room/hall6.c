/* Atreidies Underwater Base - Hall 6 */
/* by Kiza 10-Jul-1996 */
...
void reset(int arg){
  ...
  "Off to the north and south of you are located the Atreides labs.\n\n");

  add_exit("north","/d/Atreid/kiza/ubase/lab3.c");
  add_exit("south","/d/Atreid/kiza/ubase/lab4.c");
  add_exit("west","/d/Atreid/kiza/ubase/hall5.c");
  add_exit("east","/d/Atreid/kiza/ubase/hall7.c");
  add_item("emblem",
