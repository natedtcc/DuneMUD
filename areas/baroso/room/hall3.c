/* Atreidies Underwater Base - Hall 3 */
/* by Kiza 10-Jul-1996 */
...
void reset(int arg){
  ...
  "To the west is some living quarters.\n\n");

  add_exit("north","/d/Atreid/kiza/ubase/hall2.c");
  add_exit("west","/d/Atreid/kiza/ubase/res3.c");
  add_exit("east","/d/Atreid/kiza/ubase/jan1.c");
  add_exit("south","/d/Atreid/kiza/ubase/hall4.c");
  add_item("emblem",
