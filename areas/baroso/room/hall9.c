/* Atreidies Underwater Base - Hall 9 */
/* by Kiza 10-Jul-1996 */
...
void reset(int arg){
  ...
  "The Hallway continues north and south of your current location.\n\n");
  add_exit("south","/d/Atreid/kiza/ubase/hall8.c");
  add_exit("north","/d/Atreid/kiza/ubase/hall10.c");
  add_item("emblem",
