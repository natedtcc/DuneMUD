...
void reset(int arg){
  ...
  add_exit("north","/d/Atreid/kiza/ubase/groom7.c");
  add_exit("south","/d/Atreid/kiza/ubase/groom8.c");
  add_exit("west","/d/Atreid/kiza/ubase/ghall3.c");
  add_exit("east","/d/Atreid/kiza/ubase/comroom.c");
