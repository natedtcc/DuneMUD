/* Atreidies Underwater Base - Hall 5 */
/* by Kiza 10-Jul-1996 */
...
void reset(int arg){
  ...
  "To your north and south are Atreides labs.\n\n");


  add_exit("northwest","/d/Atreid/kiza/ubase/hall4.c");
  add_exit("east","/d/Atreid/kiza/ubase/hall6.c");
  add_exit("south","/d/Atreid/kiza/ubase/lab2.c");
  add_exit("north","/d/Atreid/kiza/ubase/lab1.c");
  add_item("emblem",
