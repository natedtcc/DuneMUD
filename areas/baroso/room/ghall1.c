...
void reset(int arg){
  ...
  "obviously the paitings and wall coverings were trying to hide this.");
  add_item("coverings",
  ...
  add_exit("north","/d/Atreid/kiza/ubase/groom1.c");
  add_exit("south","/d/Atreid/kiza/ubase/groom2.c");
  add_exit("west","/d/Atreid/kiza/ubase/hall10.c");
  add_exit("east","/d/Atreid/kiza/ubase/ghall2.c");
