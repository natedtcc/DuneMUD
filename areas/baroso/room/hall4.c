/* Atreidies Underwater Base - Hall 4 */
/* by Kiza 10-Jul-1996 */
...
void reset(int arg){
  ...
  add_exit("north","/d/Atreid/kiza/ubase/hall3.c");
  add_exit("west","/d/Atreid/kiza/ubase/res4.c");
  add_exit("southeast","/d/Atreid/kiza/ubase/hall5.c");
  add_item("emblem",
